...
class Evaluator():
    def __init__(self, img_loader, txt_loader):
        ...
        self.logger = logging.getLogger("McRSA.eval")
    ...
    def _compute_embedding(self, model):
        ...
        self.logger.info(f"Average time per iteration: {avg_iter_time:.4f} s / it")
    ...
    def eval(self, model, i2t_metric=True):
        ...
        t2i_cmc, t2i_mAP = t2i_cmc.numpy(), t2i_mAP.numpy()
        ...
        if i2t_metric:
            ...
            i2t_cmc, i2t_mAP = i2t_cmc.numpy(), i2t_mAP.numpy()
