...
class Flickr_30k(BaseDataset):
    def __init__(self, root='', verbose=True):
        super(Flickr_30k, self).__init__()
        self.dataset_dir = op.join(root, 'Flickr_30k')
        ...
        if verbose:
            self.logger.info("=> Flickr_30k Images and Captions are loaded")
    ...
    def _process_anno(self, annos: List[dict], training=False):
        ...
        if training:
            ...
            # 创建 pid_mapping，将 pid 映射为从 0 开始的连续编号
