...
from .flickr_30k import Flickr_30k
...
def build_dataloader(args, length = 500, tranforms=None):
    logger = logging.getLogger("McRSA.dataset")
    ...
    if args.training:#  **********************************************   training
        ...
        train_set = ImageTextDataset(dataset.train[:length],
                                 train_transforms,
        ...
        val_img_set = ImageDataset(ds['image_pids'], ds['img_paths'],
                                   val_transforms)#val_transforms:size()
